...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
#    return sorted(people_list, key=lambda person: (-len(person['hobbies']), person['name']))
    def hobbies_sort_key(person):
        return -len(person.hobbies), person.full_name

    return sorted(people_list, key=hobbies_sort_key)
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    def sort_hobbies(person):
        return len(person.hobbies), person.full_name

    return sorted(people_list, key=sort_hobbies)
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    def sort_key_by_full_name(person):
        return person.full_name

    sorted_people = sorted(people_list, key=sort_key_by_full_name)
